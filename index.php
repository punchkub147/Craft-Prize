<?php 
 ...
 ?>
	...
	<div class="container">
		...
		<?php 
			require 'connectDB.php';
			$sql = "SELECT project_name,prize_1st,prize_2nd,prize_3rd,end_at,categories.category_name,(prize_1st+prize_2nd+prize_3rd) as prize,project_id,projects.user_id,users.user_name,project_poster,project_description,NOW() as nowDate
			        FROM projects
			        LEFT JOIN categories
